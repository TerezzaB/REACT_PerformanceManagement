...
export default function InfoModal ({ isOpen, onClose, content }) {
  ...
  return createPortal(
    <div className="fixed inset-0 flex items-center justify-center bg-white bg-opacity-90 text-black z-50">
      <div className="p-6 rounded shadow-lg max-w-full sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl max-h-[90vh] overflow-y-auto _modal">
        ...
        <button className="my-6 px-4 py-2 bg_kpi_gradient text-white rounded" onClick={onClose}>Close</button>
      </div>
    </div>,
    document.body
  );
